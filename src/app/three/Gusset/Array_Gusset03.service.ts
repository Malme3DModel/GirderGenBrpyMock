...
import { Gusset03Service } from './Gusset03.service';

@Injectable({
    providedIn: 'root'
})
export class ArrayG3Service {

    constructor(private Gusset: Gusset03Service) { }
